...
position
    ...
    /**
     * This method prints the grid to console (i.e. System.out). The grid spaces 
are either
...
winner
    ...
    public static TicTacToe newInstance(String id) {
        
        TicTacToe ttt = null;
        try {
            Class clazz = Class.forName("TicTacToe" + id);
            ttt = (TicTacToe) clazz.getDeclaredConstructor().newInstance();
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(TicTacToe.class.getName()).log(Level.SEVERE, null, 
ex);
        } finally {
            return ttt;
        }
